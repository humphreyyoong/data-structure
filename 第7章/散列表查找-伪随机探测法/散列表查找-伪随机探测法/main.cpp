...
int main(int argc, const char * argv[]) {
    ...
    createHashTableByPseudoRandomDetectionMethod(hashTable,sqList); //通过伪随机探测法创建散列表
    ...
    printf("请输入你要查找数据的主键:");
    scanf("%d",&key);
    key=searchHashTableByPseudoRandomDetectionMethod(hashTable,key); //通过伪随机探测法在散列表中查找
